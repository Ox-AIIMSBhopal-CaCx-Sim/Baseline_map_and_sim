...
class Ca_Cx_pathway (object):
    ...
    def individual_results_processor(self):
        ...
        if self.patient.time_at_colposcopy == 0:
            self.individual_results['Time_to_Colposcopy'] = np.nan #a NaN implementation makes it easier to implement dropNA function later during KPI calculation
        else:
        ...
        if self.patient.time_at_treatment == 0:
            self.individual_results['Time_to_Treatment'] = np.nan
        else:
